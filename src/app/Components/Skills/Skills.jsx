...
const Skills = () => {
    ...
    return (
        <div className='mt-30'>
            ...
            {/* For PC */}
            <div className="relative mt-50 hidden md:block">
                {/* Timeline Progress */}
            ...
            {/* For Mobile */}
            <div className="mb-30 mt-15 mx-5 flex flex-col gap-10 md:hidden">
                <motion.div 
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                ...
                className="flex items-center">
                    <div className="border border-2 border-sky-500 shadow-lg shadow-white bg-white p-5 rounded-xl">
                        <h4 className='text-sky-600 text-xl font-bold'>Frontend Development</h4>
                        <p className='text-gray-700'>Building responsive, interactive, and user-friendly interfaces with modern frontend technologies and best practices.</p>
                        <h4 className='text-sky-600 text-xl font-bold mt-5'>Technologies</h4>
                        <div className='flex flex-wrap gap-3 mt-2'>
